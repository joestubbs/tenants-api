...
Revision ID: 34d1f194285a
Revises: 
Create Date: 2019-08-25 19:47:43.416407
...
def upgrade():
    ...
    sa.UniqueConstraint('bind_credential'),
    sa.UniqueConstraint('bind_dn'),
    sa.UniqueConstraint('url'),
    sa.UniqueConstraint('user_dn')
    )
